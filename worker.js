...
const BOT_TOKEN = "7414077653:AAG9D52ilhyw7WZ0gAdp0wuzs9G-pXRK9kI"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "BOT_SECRET"; // Insert a powerful secret text.
const BOT_OWNER = 6742022802; // Insert your telegram account id.
const BOT_CHANNEL = -1002180300815; // Insert your telegram channel id which the bot is admin in.
