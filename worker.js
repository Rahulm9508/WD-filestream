...
const BOT_TOKEN = "7289136166:AAGPpHK4yz99XD5x6JJixPyTlHZvjlFC5aI"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "BOT_SECRET"; // Insert a powerful secret text.
const BOT_OWNER = 7081036509; // Insert your telegram account id.
const BOT_CHANNEL = -1002278731669; // Insert your telegram channel id which the bot is admin in.
